...
KLEE.Common = (function () {
    ...
    var _serverUrl = function () {
        ...
        /*return "http://crm-mdb.integration.klee.lan.net/mdb/XRMServices/2011/OrganizationData.svc";*/
    ...
    var _searchFor = function (criteria) {
        return _retrieveMultiple(criteria.entityName, criteria.columns, criteria.filter, criteria.callback);
    };
